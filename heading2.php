    <div class="row">
      <div class="col-md-2">
		...
		<hr>
		<a class="btn btn-success" style="background-color:#gfff4" href="change_pic.php">Change Profile Picture</a>
      </div>
		<div class="col-md-5">
			<hr>
			<p>Personal Info</p>
      ...
      <div class="col-md-5">
			<form  id="upload_image"  class="form-horizontal" method="POST" enctype="multipart/form-data">
				...
				<div class="control-group">
					<div class="controls">
						<button type="submit" name="submit" style="background-color:#a64bf4" class="btn btn-success">Upload</button>
					</div>
				</div>
			</form>
							<?php
